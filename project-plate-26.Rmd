...
# second <- read.csv('output-2017-10-09/multiclass_concat.csv', as.is=TRUE)
```

```{r results='asis'}
cols <- c('name', 'tax_name', 'abundance', 'rank')
versions <- c('2017-09-14')
data <- list(first)
...
Also note that AJ534689 is poor quality and should be excluded.
...
```{r results='asis'}
knitr::kable(read.csv('output-gethits-2017-09-14/phylum/Proteobacteria/hits.csv'))
```
